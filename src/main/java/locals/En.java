...
public enum En {
    ...
    INFO_TIME_TO_CONFIRM_SINCE(
            "To confirm your account, you had `%sh` since the approbation, and connect to the Minecraft® server\n"),
